...
<div class="wrap">   
    <div class="er_plugin sat_page_settings">
        ...
        <?PHP if (empty($accountinfo) || isset($accountinfo->debug)) { ?>
            ...
            <div class="sat_box" id="sat_box_info">
                ...
                <a class="button-secondary sat_floatingrigthbuttontop" href="http://www.eranker.com/register/" target="_blank"><strong><?php _e('Setup your free account', 'er'); ?></strong></a>
                <p>
            ...
            <div class="sat_box" id="sat_box_info">
                ...
                <a class="button-secondary sat_floatingrigthbuttontop" href="http://www.eranker.com/login/" target="_blank"><strong><?php _e('Visit your eRanker account', 'er'); ?></strong> </a>
                <p>
            ...
            <div class="widget sat_widget">
                <div class="widget-top sat_nomovecursor">
                    <div class="widget-title">
                        <a class="sat_floatrigth sat_mariginleft" href="http://www.eranker.com/settings" target="_blank"><?php _e('Click here to create and view your API Credentials', 'er'); ?></a>
                        ...
                        <table class="form-table sat_table sat_noborder sat_nomargin">
                            <tr class="row_even sat_bglgray">
                                <td class="row_multi sat_nobg" style="width:200px">
                                    <label for="sat_settings_api_email"><?php _e('Email', 'er'); ?>:</label>
                                </td>
                                <td class="sat_nobg">
                            ...
                            <tr class="row_even sat_bglgray">
                                <td class="row_multi sat_nobg" style="width:200px">
                                    <label for="sat_settings_api_key"><?php _e('API Key', 'er'); ?>:</label>
                                </td>
                                <td class="sat_nobg">
                ...
                <div class="widget-top sat_nomovecursor">
                    <div class="widget-title">                       
                        <h4 ><?php _e('API account status', 'er'); ?> <span class="in-widget-title"></span>
                            <a style="font-size: 12px;" class="sat_floatrigth sat_mariginleft" href="http://www.eranker.com/settings" target="_blank"><?php _e('Account Settings at eRanker', 'er'); ?> <img src="<?PHP echo plugins_url(SAT_FOLDERNAME . '/images/icon-new-window.gif') ?>" alt="" /></a>
                        </h4>
                    </div>
                </div>
                <div class="widget-inside sat_nopadding" style="display: block;">
                        ...
                        <table class="form-table sat_table sat_noborder sat_nomargin">
                            ...
                            <tr class="row_even sat_bglgray">
                                ...
                                <td class="sat_nobg">
                                    ...
                                    ?>
                                    <a href="http://www.eranker.com/plans" target="_blank"><img src="<?PHP echo plugins_url(SAT_FOLDERNAME . '/images/' . $medalimg) ?>" alt="" class="sat_floatleft sat_mariginright"/></a>
                                    <a href="http://www.eranker.com/plans" target="_blank" style="text-decoration: none"><h3 style="height: 20px;margin: 0;padding: 0;color: <?php echo $planamecolor; ?>;"><?php echo $accountinfo->plan->display_name; ?> <img src="<?PHP echo plugins_url(SAT_FOLDERNAME . '/images/icon-new-window.gif') ?>" alt="" /></h3></a>
